<?php
	...
	$style = "background: linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url('" . $image . "') center top/cover no-repeat;";
	if ( $type === 'Box with List & CTA' ) {
		$class = 'is-size-6 box-list-hero';
		$style = "background: url('" . $image . "') center top/cover no-repeat;";
	}
	if ( $type === 'Pointed' ) {
